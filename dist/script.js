...
"use strict";
__webpack_require__.r(__webpack_exports__);
var timer = function timer(id, dedaline) {
  var getTimeRemaining = function getTimeRemaining(endtime) {
    var time = Date.parse(endtime) - Date.parse(new Date());
    var secounds = Math.floor(time / 1000 % 60);
    var minutes = Math.floor(time / 1000 / 60 % 60);
    var hours = Math.floor(time / 1000 / 60 / 60 % 24);
    var days = Math.floor(time / 1000 / 60 / 60 / 24 % 60); // console.log('secounds',secounds)
  ...
  var setClock = function setClock(selector, endtime) {
    ...
    var secounds = timer.querySelector('#seconds');
